...
const CabecalhoLista = ({
  ...
  isFiltroAtivo,
  setCarregarFiltroModalVisivel
}) => {
  return (
    <View style={styles.container}>
      <Text style={styles.textoContador}>{totalItens} produto(s)</Text>
      <View style={styles.botoesContainer}>
        <TouchableOpacity onPress={() => setCarregarFiltroModalVisivel(true)} style={styles.botao}>
          <Feather name="bookmark" size={24} color={tema.cores.preto} />
        </TouchableOpacity>
        ...
        <TouchableOpacity onPress={() => setModoVisualizacao(modoVisualizacao === 'card' ? 'tabela' : 'card')} style={styles.botao}>
