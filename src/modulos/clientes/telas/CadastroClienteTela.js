  ...
  <View style={styles.seletorContainer}>
    <TouchableOpacity
      ...
      <Text
        style={[
          styles.seletorTexto,
          tipo === 'Juridica' && styles.seletorTextoAtivo,
        ]}>
        Pessoa Jurídica
      </Text>
    </TouchableOpacity>
    <TouchableOpacity
      ...
      <Text
        style={[
          styles.seletorTexto,
          tipo === 'Fisica' && styles.seletorTextoAtivo,
        ]}>
        Pessoa Física
      </Text>
    </TouchableOpacity>
    ...
    <KeyboardAwareScrollView
      ...
      <SeletorTipoPessoa tipo={form.tipoPessoa} setTipo={(val) => handleChange('tipoPessoa', val)} editando={modoEdicao} />
        {form.tipoPessoa === 'Fisica' ? (
          <CardFormulario titulo="Dados Pessoais" icone="user">
            <InputFormulario
              ref={refs.nomeCompleto}
              label="Nome Completo *"
              valor={form.nomeCompleto}
              aoMudarTexto={(val) => handleChange('nomeCompleto', val)}
            ...
            <InputFormulario
              ...
              label="CPF"
              valor={form.cpf}
              aoMudarTexto={(val) => handleChange('cpf', val)}
              tipoTeclado="numeric"
          ...
          <CardFormulario titulo="Dados da Empresa" icone="briefcase">
            <InputFormulario
              ref={refs.razaoSocial}
              label="Razão Social *"
              valor={form.razaoSocial}
              aoMudarTexto={(val) => handleChange('razaoSocial', val)}
              erro={erros.razaoSocial}
              returnKeyType="next"
              onSubmitEditing={() => refs.nomeFantasia.current?.focus()}
            />
            <InputFormulario
              ref={refs.nomeFantasia}
              label="Nome Fantasia"
              valor={form.nomeFantasia}
              aoMudarTexto={(val) => handleChange('nomeFantasia', val)}
              erro={erros.nomeFantasia}
              returnKeyType="next"
              onSubmitEditing={() => refs.cnpj.current?.focus()}
            />
            <InputFormulario
              ref={refs.cnpj}
              label="CNPJ"
              valor={form.cnpj}
              aoMudarTexto={(val) => handleChange('cnpj', val)}
              tipoTeclado="numeric"
              formatador={formatarCNPJ}
              erro={erros.cnpj}
              returnKeyType="next"
              onSubmitEditing={() => refs.email.current?.focus()}
            />
        ...
        <CardFormulario titulo="Contato" icone="phone">
          <InputFormulario
            ...
            label="E-mail"
            valor={form.email}
            aoMudarTexto={(val) => handleChange('email', val)}
          ...
          <InputFormulario
            ...
            label="Telefone"
            valor={form.telefone}
            aoMudarTexto={(val) => handleChange('telefone', val)}
            tipoTeclado="numeric"
        ...
        <CardFormulario titulo="Endereço" icone="map-pin">
          <InputFormulario
            ...
            label="CEP"
            valor={form.cep}
            aoMudarTexto={(val) => handleChange('cep', val)}
            tipoTeclado="numeric"
            formatador={formatarCEP}
            erro={erros.cep}
          ...
          <InputFormulario
            ...
            aoMudarTexto={(val) => handleChange('logradouro', val)}
          ...
          <View style={styles.linhaEndereco}>
            <View style={{ flex: 1 }}>
              <InputFormulario
                ...
                label="Número"
                valor={form.numero}
                aoMudarTexto={(val) => handleChange('numero', val)}
                tipoTeclado="numeric"
                erro={erros.numero}
                returnKeyType="next"
            ...
            <View style={{ flex: 2 }}>
              <InputFormulario
                ...
                aoMudarTexto={(val) => handleChange('complemento', val)}
          ...
          <InputFormulario
            ...
            label="Bairro"
            valor={form.bairro}
            aoMudarTexto={(val) => handleChange('bairro', val)}
            erro={erros.bairro}
            returnKeyType="next"
          ...
          <View style={styles.linhaEndereco}>
            <View style={{ flex: 2 }}>
              <InputFormulario
                ...
                label="Cidade"
                valor={form.cidade}
                aoMudarTexto={(val) => handleChange('cidade', val)}
                erro={erros.cidade}
                returnKeyType="next"
            ...
            <View style={{ flex: 1 }}>
              <InputFormulario
                ...
                label="UF"
                valor={form.estado}
                aoMudarTexto={(val) => handleChange('estado', val)}
                maxLength={2}
        ...
        {modoEdicao && (
          <CardFormulario titulo="Status do Cliente" icone="toggle-right">
            <GrupoDeBotoes
              opcoes={[
                { id: 'Ativo', nome: 'Ativo' },
        ...
        <View style={styles.botaoContainer}>
          <Button
            title={modoEdicao ? 'Atualizar Cliente' : 'Salvar Cliente'}
...
export default CadastroClienteTela;
