...
const styles = StyleSheet.create({
    container: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingHorizontal: tema.espacamento.medio, paddingVertical: 12, backgroundColor: tema.cores.primaria },
    textoContador: { fontSize: 18, color: tema.cores.branco, fontWeight: 'bold' },
    botoesContainer: { flexDirection: 'row', alignItems: 'center', gap: tema.espacamento.grande },
    botao: { padding: tema.espacamento.pequeno },
});
